...
namespace Apo_Company {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(int customerID, string name, string surname, string phone, string address, string password, string email, string date) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string date {
                get {
                    return ((string)(this[this.tableCustomers.dateColumn]));
                }
                set {
...
namespace Apo_Company.DataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Customers] ([customerID], [name], [surname], [phone], [address], [pa" +
                "ssword], [email], [date]) VALUES (@customerID, @name, @surname, @phone, @address" +
                ", @password, @email, @date)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Customers] SET [customerID] = @customerID, [name] = @name, [surname] = @s" +
                "urname, [phone] = @phone, [address] = @address, [password] = @password, [email] " +
                "= @email, [date] = @date WHERE (([customerID] = @Original_customerID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["apo_companyConnectionString"].ConnectionString;
        }
        ...
        public virtual int Insert(int customerID, string name, string surname, string phone, string address, string password, string email, string date) {
        ...
        public virtual int Update(int customerID, string name, string surname, string phone, string address, string password, string email, string date, int Original_customerID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string surname, string phone, string address, string password, string email, string date, int Original_customerID) {
            return this.Update(Original_customerID, name, surname, phone, address, password, email, date, Original_customerID);
        }
    }
